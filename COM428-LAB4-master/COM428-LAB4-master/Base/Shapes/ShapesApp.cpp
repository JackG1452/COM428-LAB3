...
void ShapesApp::BuildRenderItems()
{
	...
	for (int i = 0; i < 5; ++i)
	{
		...
		//define the location of each cylinder
		XMMATRIX leftCylWorld = XMMatrixTranslation(-5.0f, 1.5f, -10.0f + i * 5.0f);
		XMMATRIX rightCylWorld = XMMatrixTranslation(+5.0f, 1.5f, -10.0f + i * 5.0f);

		//define the location of each sphere
		XMMATRIX leftSphereWorld = XMMatrixTranslation(-5.0f, 3.5f, -10.0f + i * 5.0f);
		XMMATRIX rightSphereWorld = XMMatrixTranslation(+5.0f, 3.5f, -10.0f + i * 5.0f);
		
		//define the left cylinder render item
		...
		//define the right cylinder render item
		...
		//define left sphere render item
		...
		//define right sphere render item
		...
		//add spheres and cylinders to the vector of render items
